...
The example below uses the terminal's default buy-side basket workflow for symbol `GP`, distributing a total quantity of `10000` across eligible BO accounts with weighted sizing.
